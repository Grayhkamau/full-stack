...
const {dummy,total_likes, favouriteBlog, mostBlogs, mostLikes} =  require('../utils/list_helper');
...
describe("most likes", ()=>{
    test("of empty likes is zero", ()=>{
        ...
        assert.strictEqual(mostLikes(blog_list),0)
    })
    ...
    test("when list has one blog equals that blog", ()=>{
        ...
        assert.deepStrictEqual(mostLikes(blog_list),{author:'Edsger W. Dijkstra',likes:5})
    })
    test('of a bigger list author with most likes is calculated right',()=>{
        let blog_list = [{
                            _id: '5a422aa71b54a676234d17f8',
                            title: 'Go To Statement Considered Harmful',
                            author: 'kamau',
